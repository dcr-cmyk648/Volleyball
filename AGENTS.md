...
- Do not add, expand, or rewrite user-facing scoreboard explanations, descriptions, help text, labels, or instructional copy when changing scoreboard behavior unless the user explicitly asks for a copy change. Preserve the existing concise UI text by default.
